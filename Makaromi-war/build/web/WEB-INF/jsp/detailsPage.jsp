                                    ...
                                    <td>
                                        <div id="texteDetailsPage">                                   
                                            ...
                                            <c:forEach items= "${myevent.representationsev}" var = "r">                                                                                    
                                                ...
                                                <p id="boutonCommander"><a href="IndexController?section=DetailsRepresentationController&idRep=${r.id}&event=${myevent.name}"><strong>Détail de la représentation</a></strong></p>
                                                <p>----------------------------------------------------------------------------------------------------</p><br/>                                                
                                            </c:forEach>
                                            <c:choose>
